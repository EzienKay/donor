...
import { backProject, connectWallet } from "../services/blockchain";
...
const Buttons = () => {
  ...
  const handleConnectWallet = async () => {
    try {
      await connectWallet(setConnectedAccount, setShowModal);
    } catch (error) {
...
{!connectedAccount ? (
        ...
        {/* Wallet Modal */}
        <WalletModal showModal={showModal} handleClose={() => setShowModal(false)} />
